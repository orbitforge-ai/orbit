...
export function ScheduleBuilderScreen() {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* Create panel */}
      {creating && (
        <div className="w-[400px] border-l border-edge flex flex-col bg-panel">
          ...
          <div className="px-4 py-3 border-t border-edge">
            <button
              ...
              className="w-full py-2 rounded-lg bg-accent hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
            >
              Create Schedule
            </button>
          </div>
