...
export function RunHistory() {
  ...
  const activeLiveLogs = selectedRunId ? (liveStore.activeRuns[selectedRunId]?.logs ?? []) : [];
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              {isLoading ? (
                ...
                <div className="p-8 text-center text-muted text-sm">No runs found</div>
              ) : (
...
function RunRow({
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-2.5 text-muted">{formatDuration(run.durationMs)}</td>
    </tr>
  );
}
