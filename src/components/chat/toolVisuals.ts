...
const TOOL_VISUALS: Record<string, ToolVisual> = {
  ...
  image_analysis: { Icon: Eye, colorClass: 'text-cyan-400' },
  image_generation: { Icon: ImagePlus, colorClass: 'text-fuchsia-400' },
  config: { Icon: Settings, colorClass: 'text-muted' },
  task: { Icon: ListChecks, colorClass: 'text-emerald-400' },
  work_item: { Icon: KanbanSquare, colorClass: 'text-emerald-400' },
